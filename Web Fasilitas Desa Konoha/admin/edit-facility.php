...
?>
	...
	<head>
		...
		<title>Facility Rent Portal | Admin Edit Facility Info</title>
												...
												foreach ($results as $result) {	?>
													...
													<form method="post" class="form-horizontal" enctype="multipart/form-data">
														<div class="form-group">
															<label class="col-sm-2 control-label">Facility Title<span style="color:red">*</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Facility Overview<span style="color:red">*</span></label>
															<div class="col-sm-10">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Price Per Day(in Rupiah)<span style="color:red">*</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															<div class="col-sm-4">
																Image 1 <img src="img/facilityimages/<?php echo htmlentities($result->Vimage1); ?>" width="300" height="200" style="border:solid 1px #000">
																<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id) ?>">Change Image 1</a>
															</div>
															<div class="col-sm-4">
																Image 2<img src="img/facilityimages/<?php echo htmlentities($result->Vimage2); ?>" width="300" height="200" style="border:solid 1px #000">
																<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id) ?>">Change Image 2</a>
															</div>
															<div class="col-sm-4">
																Image 3<img src="img/facilityimages/<?php echo htmlentities($result->Vimage3); ?>" width="300" height="200" style="border:solid 1px #000">
														...
														<div class="form-group">
															<div class="col-sm-4">
																Image 4<img src="img/facilityimages/<?php echo htmlentities($result->Vimage4); ?>" width="300" height="200" style="border:solid 1px #000">
															...
															<div class="col-sm-4">
																...
																<?php if ($result->Vimage5 == "") {
																	...
																	<img src="img/facilityimages/<?php echo htmlentities($result->Vimage5); ?>" width="300" height="200" style="border:solid 1px #000">
