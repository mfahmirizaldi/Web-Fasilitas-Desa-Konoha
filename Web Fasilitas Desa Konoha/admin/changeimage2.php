...
?>
	...
	<head>
		...
		<title>Facility Rent Portal | Admin Update Image 2</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Facility Image 2 </h2>

							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Facility Image 2 Details</div>
												...
												<div class="form-group">
													...
													if ($query->rowCount() > 0) {
														foreach ($results as $result) {	?>
															...
															<div class="col-sm-8">
																<img src="img/facilityimages/<?php echo htmlentities($result->Vimage2); ?>" width="300" height="200" style="border:solid 1px #000">
															</div>
													<?php }
													} ?>
												</div>
