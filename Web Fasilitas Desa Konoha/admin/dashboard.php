...
?>
	...
	<head>
		...
		<title>Facility Rent Portal | Admin Dashboard</title>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-title text-uppercase">Listed Facility</div>
													</div>
												</div>
												<a href="manage-facility.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										<div class="col-md-3">
											<div class="panel panel-default">
